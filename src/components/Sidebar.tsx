...
export function Sidebar({ onNewChat, isOpen, onClose }: SidebarProps) {
    // Mock recent chats
    const recentChats = [
        { id: 1, title: "Life Insurance Query", date: "Today" },
        { id: 2, title: "Travel Policy Options", date: "Yesterday" },
        { id: 3, title: "Investment Plan", date: "2 days ago" },
    ]
                        ...
                        <div className="p-4 border-t border-gray-200 bg-gray-50/50">
                            <div className="flex items-center gap-3 px-2">
                                ...
                                <div className="flex-1 overflow-hidden">
                                    <div className="text-sm font-medium text-gray-900 truncate">Swamini</div>
